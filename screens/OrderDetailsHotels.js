...
const SCREEN_HEIGHT = Dimensions.get('window').height;
  ...
  import {RadioButton, Chip,Card, Divider} from 'react-native-paper';
...
export default class OrderDetailsHotels extends Component {
  ...
  SubmitRating() {
    ...
    console.log('Driver Id: ', this.state.datas.RentStoreId);
    ...
    if (this.props.route.params.orders.OrderStatus != 'Pending') {
      ...
      firestore()
        ...
        .update({
          ...
          TransactionCancelled: firestore.FieldValue.increment(1),
          wallet: firestore.FieldValue.increment(
            this.props.route.params.orders.AppShare,
          ),
        });
      ...
      zoomEnabled={true}
        ...
        bottom: 0}}
            ...
            <Card
              ...
              <View style={{marginTop: 20, marginLeft: 20}}>
                <Text style={{fontSize: 18, fontWeight: 'bold'}}>
                  {this.state.datas.RentStoreName}
                </Text>
              </View>
              <Card
                style={{
                ...
                <QRCode value={this.state.datas.refNo} size={50} />
              </Card>
                ...
                </View>
                {
                  <TouchableOpacity
                    ...
                    <View style={{flexDirection: 'row'}}>
                      {this.state.datas.OrderStatus == 'Pending' ? (
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <View
                      ...
                      <Text style={{fontSize: 12}}>
                        ...
                        {this.state.datas.SelectedPricing == '3Hour'
                          ? parseFloat(this.state.datas.HourPrice3)
                              .toFixed(2)
                              .replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')
                          : this.state.datas.SelectedPricing == '6Hour'
                          ? parseFloat(this.state.datas.HourPrice6)
                              .toFixed(2)
                              .replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')
                          : this.state.datas.SelectedPricing == '12Hour'
                          ? parseFloat(this.state.datas.HourPrice12)
                              .toFixed(2)
                              .replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')
              ...
              <Card
                ...
                <Text
                  style={{fontWeight: 'bold', fontSize: 10, marginBottom: 10}}>
                  Guest Details{' '}
                </Text>
                <View style={{flexDirection: 'row'}}>
                  <View
                    ...
                    <Text style={{fontSize: 12}}>
                      {' '}
                      {this.state.datas.isGuest == true
                        ? this.state.datas.AccountInfo.name
                        : this.state.datas.guestName}
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Text style={{fontSize: 12}}>
                      ...
                      {this.state.datas.SelectedPricing == 'Weekly'
                        ? moment(this.state.datas.startDate * 1000)
                            .add(
                              7 * parseInt(this.state.datas.Duration),
                              'days',
                            )
                        ...
                        ? moment(this.state.datas.startDate * 1000)
                            .add(
                              30 * parseInt(this.state.datas.Duration),
                              'days',
                            )
                            .format('MMM D, YYYY hh:mm a')
                        : this.state.datas.SelectedPricing == 'Day'
                        ? moment(this.state.datas.Dateend * 1000).format(
                            'MMM D, YYYY',
                          )
                        : moment(this.state.datas.Dateend * 1000).format(
                            'MMM D, YYYY hh:mm a',
              ...
              <Card
                ...
                <View style={{flexDirection: 'row'}}>
                  ...
                  <View
                    ...
                    <Text style={{fontSize: 18, fontWeight: 'bold'}}>
                      {this.state.datas.currency}
                      {parseFloat(this.state.datas.total)
                        .toFixed(2)
                        .replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')}
                    </Text>
                    <Text
          ...
          <Modal
            ...
            animationOutTiming={700}
            useNativeDriver={true}
            onBackdropPress={() => this.setState({showCancelled: false})}
            transparent={true}>
            <Card
              style={{
                backgroundColor: 'white',
              ...
              <ScrollView>
                <View style={{flexDirection: 'column'}}>
                  ...
                  {this.props.route.params.orders.RiderCancel == undefined
                    ? null
                    : this.props.route.params.orders.RiderCancel.map(items => (
                        <Text style={{fontSize: 12}}>
                          {items.CancelledReason}
                        </Text>
                      ))}
                </View>
              </ScrollView>
