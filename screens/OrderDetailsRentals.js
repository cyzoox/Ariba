                ...
                <Text style={{fontSize: 18, fontWeight: 'bold'}}>
                  {this.state.datas.rentalType == 'Equipment'
                    ...
                    : this.state.datas.ColorMotor +
                      ' ' +
                      this.state.datas.MBrand +
                      ' ' +
                      this.state.datas.VModel}
                </Text>
              </View>
              <Card
                style={{
                ...
                <TouchableOpacity
                  ...
                  <View style={{flexDirection: 'row'}}>
                    ...
                    <View
                      ...
                      {this.state.datas.rentalType == 'Property' ? (
                        <FontAwesome5 name={'building'} size={18} />
                      ) : this.state.datas.rentalType == 'Vehicle' ? (
                        <MaterialCommunityIcons name={'car-cog'} size={18} />
                      ) : (
